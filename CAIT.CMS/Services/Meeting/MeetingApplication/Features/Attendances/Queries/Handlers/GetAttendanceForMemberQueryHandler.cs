...
namespace MeetingApplication.Features.Attendances.Queries.Handlers
{
    public class GetAttendanceForMemberQueryHandler : ResponseHandler
                                                    , IRequestHandler<GetAttendanceForMemberQuery, PaginatedResult<GetAttendanceResponse>>
    {
        #region Fields
        ...
        public async Task<PaginatedResult<GetAttendanceResponse>> Handle(GetAttendanceForMemberQuery request, CancellationToken cancellationToken)
        {
            ...
            // ---------------------------------------------------------
            var projected = _mapper.ProjectTo<GetAttendanceResponse>(query);
