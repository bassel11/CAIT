...
namespace Identity.Infrastructure.Migrations
{
    ...
    [Migration("20251015102101_AuthenticationTypes2")]
    partial class AuthenticationTypes2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Identity.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("AdDomain", "AdAccount")
                        ...
                        .HasFilter("[AdDomain] IS NOT NULL AND [AdAccount] IS NOT NULL");

                    b.HasIndex("AzureTenantId", "AzureObjectId")
                        .IsUnique()
                        .HasDatabaseName("IX_Users_Entra")
                        .HasFilter("[AzureTenantId] IS NOT NULL AND [AzureObjectId] IS NOT NULL");
